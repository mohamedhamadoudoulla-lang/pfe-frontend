...
export default function FinitionHautDeGamme() {
  ...
  useEffect(() => {
    API.get(`/pricing/package?finition=haut+de+gamme&region=${encodeURIComponent(region)}`)
      ...
      .catch(() => {
        const fallback = FALLBACK_EQUIPMENT["haut de gamme"] || [];
        setItems(fallback);
  ...
  const handleNext = async () => {
    ...
    const constructionState = { surface, floors, finitionLevel: "haut de gamme", constructionType: state?.constructionType || "moderne", totalConstructionCost: estimated };
    ...
    try {
      ...
      navigate("/recommandation-materiaux/_fallback", {
        state: { ...state, construction: constructionState, furnishing: furnishingState, _fallbackSurface: surface, _fallbackScenario: "premium" },
      });
    }
  };
  ...
  return (
    <div className="fin-page">
      ...
      <div className="fin-container">
        <div className="fin-shop-summary" style={{ borderLeft: "4px solid #7c3aed" }}>
          ...
          <div className="fin-shop-item">
            ...
            <a href="tel:+21655709086" style={{ padding: "8px 16px", background: "#7c3aed", color: "white", border: "none", borderRadius: 8, fontSize: 12, fontWeight: 600, cursor: "pointer", textDecoration: "none", display: "flex", alignItems: "center", gap: 4, flexShrink: 0 }}>
