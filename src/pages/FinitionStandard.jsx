...
export default function FinitionStandard() {
  ...
  useEffect(() => {
    ...
    API.get(`/pricing/package?finition=standard&region=${encodeURIComponent(region)}`)
      .then((res) => {
    ...
    <div className="fin-page">
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .fin-hero { padding: 40px 20px 30px; text-align: center; background: linear-gradient(135deg, #3b82f6, #2563eb); position: relative; overflow: hidden; }
        .fin-hero::before { content: ''; position: absolute; top: -50%; left: -50%; width: 200%; height: 200%; background: radial-gradient(circle at 70% 50%, rgba(255,255,255,0.1) 0%, transparent 50%); animation: finShineStd 8s ease-in-out infinite; }
        @keyframes finShineStd { 0%, 100% { transform: translateX(0); } 50% { transform: translateX(-30px) rotate(-5deg); } }
        ...
        .fin-form-group input:focus, .fin-form-group select:focus { border-color: ${ACCENT}; box-shadow: 0 0 0 3px rgba(59,130,246,0.15), 0 0 0 6px rgba(59,130,246,0.05); transform: scale(1.01); }
        .fin-calc-bar { display: flex; justify-content: space-between; align-items: center; margin-top: 16px; background: #eff6ff; border: 1px solid ${ACCENT}; border-radius: 12px; padding: 14px 16px; animation: finPulse 0.4s ease-out; }
        .fin-calc-label { font-size: 13px; color: #1e40af; font-weight: 500; }
        .fin-calc-value { font-size: 20px; font-weight: 800; color: #2563eb; }
        ...
        .fin-pack-btn { padding: 6px 14px; background: #eff6ff; color: #2563eb; border: 1px solid #3b82f6; border-radius: 8px; font-size: 11px; font-weight: 600; cursor: pointer; transition: all 0.25s cubic-bezier(0.4, 0, 0.2, 1); font-family: inherit; position: relative; overflow: hidden; }
        .fin-pack-btn::after { content: ''; position: absolute; inset: 0; background: #3b82f6; transform: scaleX(0); transform-origin: left; transition: transform 0.3s ease; }
        ...
        .fin-cat-card:hover { box-shadow: 0 8px 24px rgba(59,130,246,0.08); }
        ...
        .fin-cat-icon { width: 36px; height: 36px; border-radius: 10px; overflow: hidden; background: #dbeafe; display: flex; align-items: center; justify-content: center; transition: transform 0.3s ease; }
        .fin-cat-icon:hover { transform: rotate(-10deg) scale(1.1); }
        .fin-cat-icon img { width: 100%; height: 100%; object-fit: cover; }
        .fin-cat-icon span { font-size: 14px; font-weight: 700; color: #2563eb; }
        .fin-cat-name { font-size: 15px; font-weight: 700; color: #1f2937; }
        .fin-cat-meta { font-size: 11px; color: #9ca3af; margin-top: 2px; }
        .fin-cat-price { font-size: 16px; font-weight: 800; color: #3b82f6; transition: all 0.3s ease; }
        ...
        .fin-item-card::before { content: ''; position: absolute; inset: 0; background: linear-gradient(135deg, transparent 50%, rgba(59,130,246,0.03) 100%); opacity: 0; transition: opacity 0.3s; z-index: 1; pointer-events: none; }
        .fin-item-card:hover { border-color: #3b82f6; box-shadow: 0 8px 24px rgba(59,130,246,0.2); transform: translateY(-4px) scale(1.02); }
        .fin-item-card:hover::before { opacity: 1; }
        .fin-item-card.selected { border-color: #3b82f6; background: #eff6ff; box-shadow: 0 4px 16px rgba(59,130,246,0.2); transform: translateY(-2px); }
        ...
        .fin-card-img-placeholder { width: 100%; height: 100%; background: linear-gradient(135deg, #dbeafe, #bfdbfe); display: flex; align-items: center; justify-content: center; transition: background 0.3s; }
        .fin-item-card:hover .fin-card-img-placeholder { background: linear-gradient(135deg, #bfdbfe, #93c5fd); }
        ...
        .fin-item-card.selected .fin-card-check { background: #3b82f6; border-color: #3b82f6; transform: scale(1.1); box-shadow: 0 0 0 4px rgba(59,130,246,0.2); }
        ...
        .fin-item-card.selected .fin-card-name { color: #1e40af; }
        ...
        .fin-card-price { font-size: 15px; font-weight: 800; color: #3b82f6; transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1); display: inline-block; }
        .fin-item-card.selected .fin-card-price { color: #2563eb; animation: finPriceBounceBlue 0.4s ease-out; }
        @keyframes finPriceBounceBlue { 0% { transform: scale(1); } 50% { transform: scale(1.2); } 100% { transform: scale(1); } }
        ...
        .fin-btn-back:hover { background: #f9fafb; border-color: #3b82f6; color: #3b82f6; transform: translateX(-2px); }
        .fin-btn-next { display: flex; align-items: center; gap: 8px; padding: 12px 24px; background: #3b82f6; color: white; border: none; border-radius: 12px; font-size: 14px; font-weight: 700; cursor: pointer; transition: all 0.25s cubic-bezier(0.4, 0, 0.2, 1); position: relative; overflow: hidden; }
        ...
        .fin-btn-next:hover { background: #2563eb; transform: scale(1.03); box-shadow: 0 4px 16px rgba(59,130,246,0.4); }
      ...
      <div className="fin-hero">
        ...
        <h1>Finition Standard</h1>
        <p>Le meilleur equilibre entre qualite et budget</p>
        <div className="fin-badges">
          <span className="fin-badge">~900 DT/m2 construction</span>
          <span className="fin-badge">Qualite solide</span>
      ...
      <div className="fin-container">
        ...
        <div className="fin-shop-summary" style={{ borderLeft: "4px solid #3b82f6", marginBottom: 16 }}>
          ...
          <div className="fin-shop-item">
            <div style={{ width: 40, height: 40, borderRadius: 10, background: "#dbeafe", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: 14, color: "#1e40af" }}>DM</div>
            <div style={{ flex: 1 }}>
            ...
            <a href="tel:+21655709086" style={{ display: "inline-flex", alignItems: "center", gap: 4, background: "#3b82f6", color: "white", padding: "6px 12px", borderRadius: 8, fontSize: 12, fontWeight: 600, textDecoration: "none" }}><Phone size={12} /> Appeler</a>
          </div>
        </div>
        ...
        <div className="fin-construct-card">
          <div className="fin-construct-grid">
            <div className="fin-form-group">
              ...
              <input type="number" min="30" placeholder="Ex: 150" value={surface} onChange={(e) => setSurface(e.target.value)} />
            </div>
            <div className="fin-form-group">
          ...
          {surface && (
            <div className="fin-calc-bar">
              <div>
                ...
                <div style={{ fontSize: "10px", color: "#1e40af" }}>{surface} m2 x {COUT_M2} DT x {floors}</div>
              </div>
        ...
        <div className="fin-pack-section">
          <div className="fin-pack-header">
            <div className="fin-pack-title">Pack equipement standard</div>
      ...
      <div className="fin-cta-bar">
        ...
        <div className="fin-total-anim" style={{ fontSize: "22px", fontWeight: "800", color: "#2563eb" }}>{displayTotal.toLocaleString()} DT</div>
